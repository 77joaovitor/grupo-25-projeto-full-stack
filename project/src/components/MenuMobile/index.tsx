...
const MenuMobile = () => {
  const { user, menuOpen, setMenuOpen, setIsDropDown, isDropdown, isModalUpdateAddress, isModalUpdateProfile, setIsModalUpdateAddress, setIsModalUpdateProfile } = UserContext();
