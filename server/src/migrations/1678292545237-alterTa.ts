...
export class alterTa1678292545237 implements MigrationInterface {
    name = 'alterTa1678292545237'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "body" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "announcementId" uuid, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "email" character varying(50) NOT NULL, "password" character varying(150) NOT NULL, "cpf" character varying(14), "phone" character varying(20) NOT NULL, "description" character varying(200) NOT NULL, "birthdate" TIMESTAMP NOT NULL, "isAdvertiser" boolean NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "pin" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "addressesId" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "REL_ee9fa00c4b7e9d9357a22b1227" UNIQUE ("addressesId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "addresses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "zipCode" character varying(20) NOT NULL, "city" character varying(50) NOT NULL, "state" character varying(50) NOT NULL, "road" character varying(50) NOT NULL, "number" character varying(20) NOT NULL, "complement" character varying(200) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "userId" uuid, CONSTRAINT "REL_95c93a584de49f0b0e13f75363" UNIQUE ("userId"), CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_ee9fa00c4b7e9d9357a22b12275" FOREIGN KEY ("addressesId") REFERENCES "addresses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
